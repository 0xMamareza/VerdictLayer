# Consenza Public Deployment Readiness
...
- Consenza builds as a static Vite frontend.
...
| `VITE_VERDICTLAYER_CONTRACT_ADDRESS` | Identifies Consenza's deployed `VerdictLayer` contract. | `0xf7931C9C809b31B516b6C8fF199cA2e7819165d5` | Required for real reads and writes. | Contract addresses are public; this must never be replaced with a private key or wallet secret. |
...
- Consenza never requests a seed phrase or private key.
...
- The GenLayer SDK bundle includes dormant built-in localnet endpoint constants. Consenza source selects Studionet and contains no localhost runtime endpoint configuration.
